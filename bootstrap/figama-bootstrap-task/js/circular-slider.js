(function () {
    ...
    function startSetup(sliderSize, slideSize, animationDuration, autoplayInterval) {
        ...
        this.slideSize = parseFloat(slideSize) / 90;
    ...
    function Slider(newSlider, sliderSize, slideSize, animationDuration, autoplayInterval) {
        ...
        this.stepAngle = 1 * Math.PI / newSlider.querySelectorAll('.circular-slider .wrapper .slides-holder .slides-holder__item').length;
